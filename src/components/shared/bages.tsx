...
export const CompleteBage = ({ title = 'Completo' }: { title?: string }) => (
...
export const ProgressBage = ({ title = 'Em Progresso' }: { title?: string }) => (
...
export const CloseBage = ({ title = 'Terminado' }: { title?: string }) => (
