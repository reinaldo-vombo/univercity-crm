   ...
   return (
      <div className='grid grid-cols-3 gap-3'>
         {Array.from({ length: 3 }).map((_, index) => (
            <Skeleton className="visa-card" key={index}>
               ...
               <div className="name-date-cvv-container">
                  <div className="name-wrapper">
                     <input className="inputstyle" id="holderName" placeholder="NAME" type="text" />
                  </div>
                  <div className="expiry-wrapper">
                     <input className="inputstyle" id="expiry" placeholder="MM/YY" type="text" />
                  </div>
                  <div className="cvv-wrapper">
                     <input className="inputstyle" placeholder="***" maxLength={3} id="cvv" type="password" />
                  </div>
               </div>
            </Skeleton>
         ))}
