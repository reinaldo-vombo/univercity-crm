...
const schema = z.object({
  ...
  NEXT_PUBLIC_UNIVERCITY_LOCATION: z.string().min(1),
  NEXT_PUBLIC_UNIVERCITY_EMAIL: z.string().min(1),
  NEXT_PUBLIC_UNIVERCITY_PHONE: z.string().min(1),
...
const parsed = schema.safeParse({
  ...
  NEXT_PUBLIC_UNIVERCITY_LOCATION: process.env.NEXT_PUBLIC_UNIVERCITY_LOCATION,
  NEXT_PUBLIC_UNIVERCITY_PHONE: process.env.NEXT_PUBLIC_UNIVERCITY_PHONE,
  NEXT_PUBLIC_UNIVERCITY_WEBSITE: process.env.NEXT_PUBLIC_UNIVERCITY_WEBSITE,
  NEXT_PUBLIC_UNIVERCITY_EMAIL: process.env.NEXT_PUBLIC_UNIVERCITY_EMAIL,
});
